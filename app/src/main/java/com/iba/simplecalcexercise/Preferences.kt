...
class SwitchCompatStore(private val preferences: SharedPreferences, private val id:Int) {
    var isChecked: Boolean by PreferencesDelegate(preferences, id.toString(), false)
}